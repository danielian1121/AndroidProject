...
import com.mmlab.m1.save_data.Utils;
                ...
                case PROXY_UPDATE_CURRENT_MULTIMEDIA:
                    ...
                    if ((tmpMediaLength = Preset.loadFilePreferences(service.getApplicationContext(), Utils.urlToFilename(tmpRemoteUri))) == -1) {
                        try {
                            ...
                            intent1.setAction(SHOW_PROGRESS_DIALOG);
                            service.sendBroadcast(intent1);
...
//                                + Utils.urlToFilename(tmpRemoteUri));
                            ...
                            Preset.saveFilePreferences(service.getApplicationContext(), Utils.urlToFilename(tmpRemoteUri), 0);
                            ...
                            if (responseCode == HttpURLConnection.HTTP_OK) {
                                ...
                                if (tmpMediaLength < 0) {
                                    ...
                                    Preset.removeFilePreferences(service.getApplicationContext(), Utils.urlToFilename(tmpRemoteUri));
                                    return;
                                }
                            } else {
                                Intent intent = new Intent();
