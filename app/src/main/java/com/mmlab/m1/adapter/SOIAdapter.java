...
import com.mmlab.m1.SOIActivity;
...
public class SOIAdapter extends RecyclerView.Adapter<SOIAdapter.SOIViewHolder> {
    ...
    public SOIAdapter(Context context, ArrayList<LOIModel> models, ProxyService service) {
    ...
    @Override
    public SOIAdapter.SOIViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        return new SOIAdapter.SOIViewHolder(LayoutInflater.from(parent.getContext()).inflate(
                R.layout.list_item, parent, false));
    }

    @Override
    public void onBindViewHolder(SOIAdapter.SOIViewHolder holder, int position) {
...
//		TextDrawable drawable = mDrawableBuilder.build(String.valueOf(model.getLOIName().charAt(0)), mColorGenerator.getColor(position+1));
        ...
        drawable1 = mDrawableBuilder.build(String.valueOf("主"), mContext.getResources().getColor(R.color.md_light_blue_A700));
        ...
        holder.listItem.setOnClickListener(new View.OnClickListener() {
            ...
            proxyService.setSOImodel(model);
               /* Intent intent = new Intent(view.getContext(), SOIActivity.class);
                Bundle bundle = new Bundle();
                bundle.putParcelable("SOI-Content", model);
    ...
    public static class SOIViewHolder extends RecyclerView.ViewHolder {
        ...
        public SOIViewHolder(final View itemView) {
            super(itemView);
